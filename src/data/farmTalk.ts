...
export const FARM_TALK: Readonly<Record<string, readonly FarmTalkBeat[]>> = {
  ...
  bram3: [
    ...
    { speakerId: 'bram', textLabel: 'farmDialogBram3d', emotion: 'thinking' },
  ],
  bramDone: [
  ...
  // she hands over afterwards are the rules that come with having done so.
  dot1: [
    ...
    { speakerId: RUE, textLabel: 'farmDialogDot1n' },
    { speakerId: 'dot', textLabel: 'farmDialogDot1o', emotion: 'doubtful' },
    { speakerId: RUE, textLabel: 'farmDialogDot1p' },
    { speakerId: 'dot', textLabel: 'farmDialogDot1q' },
    { speakerId: 'dot', textLabel: 'farmDialogDot1r' },
    { speakerId: RUE, textLabel: 'farmDialogDot1s' },
    { speakerId: 'dot', textLabel: 'farmDialogDot1t' },
  ],
  dot2: [
