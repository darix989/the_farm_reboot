...
const LABELS = {
  ...
  mainMenuOther: 'Other',
  mainMenuBack: 'Back',
  mainMenuFollowUps: 'Follow-ups',
  menuTalkDot1: 'Welcome',
  menuTalkDot2: 'Pointer: Cass (the trick)',
  menuTalkDot3: 'Pointer: Hetty (the trough)',
  menuTalkDot4: 'Pointer: Cass (how many)',
  menuTalkDot5: 'Pointer: Hetty (the grate)',
  menuTalkDot6: 'Pointer: Bram (the grate)',
  menuTalkDot7: 'Pointer: Duchess',
  menuTalkDotDone: 'Done',
  menuTalkBram1: 'How a conversation works',
  menuTalkBram2: 'The line you have to earn',
  menuTalkBram3: 'The bent grate',
  menuTalkBramMeet: 'Meet (locked)',
  menuTalkBramDone: 'Done',
  menuTalkCass1: 'The name of the trick',
  menuTalkCass2: 'How many, not how',
  menuTalkCassMeet: 'Meet (locked)',
  menuTalkCassDone: 'Done',
  menuTalkHetty1: 'All about you',
  menuTalkHetty2: 'What Hetty saw',
  menuTalkHettyMeet: 'Meet (locked)',
  menuTalkHettyDone: 'Done',
  menuTalkDuchess1: 'The pond motion',
  menuTalkDuchessMeet: 'Meet (locked)',
  ...
  menuTalkFollowUpCassAdHominem: 'Cass — after 1.2',
  menuTalkFollowUpHettyBarrage: 'Hetty — after 1.3',
  menuTalkFollowUpCassPopularity: 'Cass — after 1.4',
  menuTalkFollowUpHettyGrate: 'Hetty — after 1.5',
  menuTalkFollowUpBramUnlocks: 'Bram — after 1.6',
  menuTalkFollowUpBramSkirmish: 'Bram — after 1.7',
  menuTalkFollowUpDuchessBoss: 'Duchess — after 1.8',
