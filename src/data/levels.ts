...
export interface ScenarioEntry {
   ...
   *
   * A gated encounter is still *offered* — the animal talks, and the Talk button carries the
   * reason it is disabled. Being told "not yet, and here is why" is content; a silent animal is
   * a bug report.
   *
