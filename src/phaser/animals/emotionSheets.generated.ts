...
> = {
  ...
  cow: {
    angry: {
      ...
      reviewNotes: [
        'First attempt read as sulking rather than angry despite clean numbers; this retry bellows convincingly but is still worth a second look in game.',
      ],
    },
    approving: {
  ...
  dog: {
    ...
    sneaky: {
      ...
      reviewNotes: [
        'height swing is a head dip, not a pose collapse — accepted, same class as donkey sneaky',
      ],
    },
    talking: {
  ...
  pig: {
    angry: {
      ...
      reviewNotes: [
        'Approved with a check label: expression reads as a subdued head-down huff rather than strong anger, despite passing quality metrics.',
      ],
    },
    doubtful: {
      file: 'pig-doubtful.png',
      frameWidth: 512,
      frameHeight: 512,
      frameCount: 25,
      frameRate: 13,
