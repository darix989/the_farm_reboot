...
| `trial/components/TrialActionRow.tsx` | Analyze / Back / Continue icon row, shared by the debate Actions panel and the overworld talk. Owns A / S / Enter / Space / D (and farm-talk E) shortcuts. Hold Shift to see the keys; Shift+key does not fire them. |
