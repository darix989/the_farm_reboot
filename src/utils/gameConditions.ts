 ...
 *
 * - **Encounter gates** (`ScenarioEntry.requires`) — an animal will talk to you, but the button
 *   that starts their encounter stays disabled until the conditions are met.
